...
Game::Game(QWidget *parent){
    ...
    // create the player
    player = new Player();
    player->setPos(400,500); // TODO set the play at the surface of the sea when starts the game
    // make the player focusable so it can be controlled
...
int Game::drawForeground(){
    m_fps++;
    return m_fps;
}

void Game::UpdateFps(){
// check Fps calculator update and player position update
